...
namespace ExpenseManager.DataAccess.Migrations
{
    ...
    [Migration("20190920122725_Migration-06")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.AccountTransfer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.Income", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.IncomeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.UserSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.AccountTransfer", b =>
                {
                    b.HasOne("ExpenseManager.Entities.Concrete.Account", "DestinationAccount")
                        .WithMany("DestinationAccountTransfers")
                    ...
                    b.HasOne("ExpenseManager.Entities.Concrete.Account", "SourceAccount")
                        .WithMany("SourceAccountTransfers")
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.Income", b =>
                {
                    b.HasOne("ExpenseManager.Entities.Concrete.Account", "Account")
                        .WithMany("Incomes")
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ExpenseManager.Entities.Concrete.IncomeCategory", "Category")
                        .WithMany("Incomes")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ExpenseManager.Entities.Concrete.UserSettings", b =>
                {
                    b.HasOne("ExpenseManager.Entities.Concrete.Profile", "DefaultProfile")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ExpenseManager.Auth.Concrete.ApplicationUser", null)
                        .WithMany()
